...
export async function getGezondheidLayerGeoJson() {
...
function getFillColor(buurtData) {
    let color = null;
    var totaal = buurtData.aantalInwoners * buurtData.wijkInfo.gezondheid.percentageGoedOfZeerErvarenGezondheid;
